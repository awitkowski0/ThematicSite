...
export const Route = createFileRoute('/sitemap.xml')({
  server: {
    handlers: {
      GET: async () => {
        const staticPaths = ['/', '/suits', '/faq', '/play', '/gotham', '/book', '/blog', '/mechanics', '/mechanics/stats', '/mechanics/rarities', '/mechanics/shiny', '/mechanics/keybinds', '/mechanics/ores', '/abilities', '/matchup', '/planner', '/structures']
